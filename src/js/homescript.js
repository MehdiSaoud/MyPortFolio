...
var changeBurgerIds = ['maison-vapeur','roleplay', 'hajime', 'feed', 'pastry', 'portfolio', 'borne', 'js_projects', 'skills', 'about'];

var scrollIds = ['maison-vapeur', 'roleplay', 'hajime', 'feed', 'pastry', 'portfolio', 'borne', 'skills'];
